...
q = """
SELECT *
FROM `vessel_identity_staging.fishing_effort_all_5th_deg_v20211101`
"""
...
q = """
SELECT *
FROM `vessel_identity_staging.fishing_effort_known_vs_all_5th_deg_v20211101`
"""
...
#                                        xlabel='Ratio',
                                       ylabel='Fishing\nHours\n(per $\mathregular{km^2}$)', fontsize=14,
...
q = """
SELECT *
FROM `vessel_identity_staging.fishing_effort_auth_vs_all_5th_deg_v20211101`
"""
authorized = pd.read_gbq(q, project_id='world-fishing-827', dialect='standard')
...
q = """
SELECT *
FROM `vessel_identity_staging.fishing_effort_auth_vs_all_ratio_by_fao_area_v20211101`
"""
...
q = """
SELECT *
FROM `vessel_identity_staging.fishing_effort_auth_vs_all_5th_deg_trfmo_v20211101`
"""
authorized = pd.read_gbq(q, project_id='world-fishing-827', dialect='standard')
grid_total, grid_ratio = make_raster(authorized, 5, 'fishing_hours_authorized_vessels')
...
#                                        xlabel='Ratio of Fishing Hours by RFMO Authorization Matched Vessels to Those by All',
    ...
    plt.title("Tuna RFMO Areas: Ratio of Fishing by Vessels with Unknown Authorization (2019-2020)", 
              fontsize=18)
    plt.show()
...
q = """
SELECT *
FROM `vessel_identity_staging.fishing_effort_auth_vs_all_5th_deg_squid_rfmo_v20211101`
"""
authorized = pd.read_gbq(q, project_id='world-fishing-827', dialect='standard')
grid_total, grid_ratio = make_raster(authorized, 5, 'fishing_hours_authorized_vessels')
...
#                                        xlabel='Ratio of Fishing Hours by RFMO Authorization Matched Vessels to Those by All',
    ...
    plt.title("Squid Fishing Areas: Fishing by Vessels with Unknown Authorization (2019-2020)", 
              fontsize=18)
    plt.show()
